...
function Luna:CreateWindow(WindowSettings)
	...
	LoadingFrame.Version.Text = LoadingFrame.Frame.Frame.Title.Text == "Luna Interface Suite" and Release or "Joshie"
...
Instance.new("UICorner", HomeTabPage.icon.ImageLabel).CornerRadius = UDim.new(0, 10)
		HomeTabPage.player.Text.Text = "Hello, " .. (Players.LocalPlayer.DisplayName ~= "" and Players.LocalPlayer.DisplayName:sub(1,1):upper() .. Players.LocalPlayer.DisplayName:sub(2) or "") .. " [" .. rank .. "]"
